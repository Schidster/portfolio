...
<section class="w-screen h-screen flex justify-center overflow-y-scroll overflow-x-clip bg-dark-900 text-white">
	<section class="w-full max-w-2xl flex flex-col">
		<nav class="my-6 w-full">
